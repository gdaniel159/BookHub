    ...
    if (isset($_POST['btnRegister'])) {
        ...
        try {
            ...
            $sql = "
                ...
                INSERT INTO cuentausuarios (id_tipo_cuenta, nombres, apellidos,genero, fecha_nacimiento, correo, contraseña) VALUES (1,'$nombres','$apellido','$genero','$fecha','$correo','$contraseña');
                ...
                INSERT INTO `administradores` (id_cuenta) VALUES (@last_id);
